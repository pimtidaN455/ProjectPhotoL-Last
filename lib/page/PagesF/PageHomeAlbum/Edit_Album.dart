...
class Edit_Album_Page extends StatefulWidget {
  var namebum;
  Edit_Album_Page({Key? key, required this.namebum}) : super(key: key);
  @override
  Edit_Album_PageState createState() =>
      Edit_Album_PageState(namebum: this.namebum);
}

class Edit_Album_PageState extends State<Edit_Album_Page> {
  var namebum;
  Edit_Album_PageState({
    required this.namebum,
  });
  late double screen;
          ...
          if (validate) {
            ...
            MaterialPageRoute materialPageRoute = MaterialPageRoute(
                builder: (BuildContext context) =>
                    Edit_Album_Page(namebum: this.namebum));
